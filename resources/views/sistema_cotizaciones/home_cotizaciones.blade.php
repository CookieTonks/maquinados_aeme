  ...
  <div id="wrapper">
          ...
          <div class="table-responsive">
            <table id="dtBasicExample" class="table table-striped table-bordered table-lg" width="100%">
              ...
              <tbody style="text-align: center;text-align: -webkit-center;">
                ...
                @if($cotizacion->estatus=='URGENTE')
                <tr class="table-danger">
                  <td>
                    <div style="width: -moz-max-content;width: max-content;">
                      <a href="{{route('home_cotizaciones_partidas', $cotizacion)}}" class="btn btn-info btn-sm"><i class="fas fa-plus"></i></a>
                      <a href="{{route('edicion_cotizacion', $cotizacion)}}" class="btn btn-info btn-sm"><i class="fas fa-edit"></i></a>
                    </div>
                  </td>
                ...
                @elseif($cotizacion->estatus=='ASIGNADA')
    ...
    <div class="modal fade" id="altamodal" tabindex="10" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="staticBackdropLabel">ALTA COTIZACION</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="{{route('home_cotizaciones_registro')}}" method="post" enctype="multipart/form-data">
              @csrf
              <div class="form-row">
                <div class="col-md-12 mb-3">
                  <label>EMPRESA</label>
                  <select class="custom-select" name="empresa" required>
                    <option selected>MAQUINADOS AEME</option>
              ...
              <div class="form-row">
                <div class="col-md-12 mb-3">
                  <label>CLIENTE</label>
                  <select class="form-control" id="cliente_cotizacion" name="cliente" required>
                    <option value="" class="form-control"></option>
                    @foreach($cliente as $item)
                    <option class="form-control" value="{{$item->nombre}}" name="cliente" value="1">{{$item->nombre}}</option>
                    @endforeach
                  </select>
                </div>
              </div>
    ...
    <script>
      ...
      $(function() {
        $("#cliente_cotizacion").change(function() {
          if ($(this).val() == "DNMX DENSO México S.A de C.V.") {
            $("#moneda").val("USD");
