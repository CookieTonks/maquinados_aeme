        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{route('home_embarques')}}">
                    <span>Salidas de embarques</span></a>
            </li>
            <hr class="sidebar-divider d-none d-md-block">

            <li class="nav-item">
                <a class="nav-link" href="{{route('buscador_embarques')}}">
                    <span>Buscador embarques</span></a>
            </li>
                        ...
                        <table id="dtBasicExample" class="table table-striped table-bordered table-lg" width="100%">
                            <thead>
                                <tr style="text-align: center;">
                                    ...
                                    <th class="th-sm">Tipo de salida</th>
                                    <th class="th-sm">Dureza</th>
                                    <th class="th-sm">Solicita</th>
                                    <th class="th-sm">Proveedor</th>
                                    <th class="th-sm">Cantidad de piezas</th>
                                    <th class="th-sm">Chofer</th>
                                    <th class="th-sm">Criterios</th>
                            ...
                            <tbody style="text-align: center;">
                                ...
                                <tr>
                                    <td><u><a style="color:#000000;" href="../storage/app/public/calidad/SC-{{$item->folio}}/SC-{{$item->folio}}.rar">SC-{{$item->folio}}</a></u></td>
                                    <td>{{$item->ot}}</td>
