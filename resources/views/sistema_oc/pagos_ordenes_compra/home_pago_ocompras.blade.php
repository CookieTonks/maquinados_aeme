                ...
                <!-- Begin Page Content -->
                 <div class="card-body">
                   ...
                   @if (session('mensaje'))
                    ...
                    <form action="{{route('alta_pago_compras')}}" method="post" enctype="multipart/form-data">
                        @csrf
                      <div class="form-row">
                        <div class="col-md-12 mb-3">
                         <label for"">ORDEN DE COMPRA</label>
                          <select name="orden_compra" id="orden_compra" class="form-control">
                           <option value="" class="form-control" name=""> Selecciona OC </option>
                            @foreach($orden_compra as $item)
                           <option value="{{$item->Codigo}}" class="form-control" name="orden_compra"> {{$item->Codigo}}</option>
                            @endforeach
                         </select>
                         </div>
                      </div>
