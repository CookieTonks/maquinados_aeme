                   ...
                   @if (session('mensaje'))
                    ...
                    <div style="display:none;">
                      <textarea id="code" style="widtz h: 200%;" rows="20">
                          st=>start: <?php if($ruta_ot->ot=='-'){echo "OT:{$ruta_ot->ot}\n";}else{echo "OT: {$ruta_ot->ot}|invalid\n";} ?>
                          e=>end: <?php if($ruta_ot->compras_salida=='-'){echo "PRODUCCION\n";}else{echo "PRODUCCION|invalid\n";} ?>
                          op1=>operation: <?php if($ruta_ot->compras_requisicion=='-'){echo "REQUISICION\n";}else{echo "REQUISICION|invalid\n";} ?>
                          op2=>operation: <?php if($ruta_ot->compras_oc=='-'){echo "ORDEN DE COMPRA\n";}else{echo "ORDEN DE COMPRA|invalid\n";} ?>
                          op3=>operation: <?php if($ruta_ot->compras_entrada=='-'){echo "ENTRADA ALMACEN\n";}else{echo "ALMACEN|invalid\n";} ?>
                 ...
                 <div class="table-responsive">
                   <table id="dtBasicExample" class="table table-striped table-bordered table-lg" width="100%">
                     ...
                     <tbody style="text-align: center;text-align: -webkit-center;">
                       @foreach($registro_ot as $registro)
                       <tr>
                         <td>{{$registro->ot}}</td>
