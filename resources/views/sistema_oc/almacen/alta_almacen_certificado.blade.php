        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('almacen_certificado_registro',$mostrar)}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label>Numero de requisicion</label>
                                <input type="text" class="form-control" name="numero_partida" value="{{$mostrar->partida}}" readonly>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-12 mb-3">
                                <label>Certificado de material </label>
                                <input type="file" class="form-control" name="certificado_material" accept=".pdf" required>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-md-6 mb-2">
                                <a href="{{route('home_almacen')}}" class="btn btn-primary btn-block">Regresar</a>
                            </div>
                            <div class="col-md-6 mb-2">
