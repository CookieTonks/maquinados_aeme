...
<body id="page-top">
  ...
  <div id="wrapper">
                  ...
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-2xl	 font-weight-bold text-primary text-uppercase mb-1">
                        <button type="button" class="btn btn-success btn-info" data-toggle="modal" data-target="#salida_material_gallinero"></i>ALMACEN AL GALLINERO</button>
                      </div>
                    </div>
                    <div class="col-auto">
              ...
              <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-2xl	 font-weight-bold text-primary text-uppercase mb-1">
                        <button type="button" class="btn btn-success btn-info" data-toggle="modal" data-target="#salida_material_usuario"></i>ALMACEN AL USUARIO</button>
                      </div>
                    </div>
                    <div class="col-auto">
    ...
    <!-- Logout Modal-->
    <div class="modal fade" id="salida_material_gallinero" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">ALMACEN ➜ GALLINERO</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="{{route('salida_material_gallinero_barcode')}}" method="post">
              @csrf
              <div class="form-row">
                <div class="col-md-6 mb-3">
                  <label>MATERIAL</label>
                  <input type="text" class="form-control" name="material" required value="">
                </div>
                <div class="col-md-6 mb-3">
                  <label>USUARIO</label>
    ...
    <div class="modal fade" id="salida_material_usuario" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">ALMACEN ➜ USUARIO</h5>
            <button class="close" type="button" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">×</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="{{route('salida_material_usuario_barcode')}}" method="post">
              @csrf
              <div class="form-row">
                <div class="col-md-6 mb-3">
                  <label>MATERIAL</label>
