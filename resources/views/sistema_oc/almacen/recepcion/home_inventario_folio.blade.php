        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="card-body">
                    ...
                    <div class="card-body">
                        <form action="{{route('home_inventario_folio_registro')}}" method="post">
                            @csrf
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label>FOLIO</label>
                                    <input value="SAF-{{$folio->salida_folio+1}}" type="text" class="form-control" name="folio" readonly>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label>ENTREGA</label>
                                    <input value="{{Auth::user()->name}}" type="text" class="form-control" name="entrega" readonly>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                        ...
                        <div class="table-responsive">
                            <table id="dtBasicExample" class="table table-striped table-bordered table-lg" width="100%">
                                ...
                                <tbody style="text-align: center;text-align: -webkit-center;">
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('home_inventario_partidas', $registro)}}" class="btn btn-success btn-sm"><i class="fas fa-plus-square"></i></a>
                                        </td>
                                        <td>{{$registro->folio}}</td>
                                        <td>{{$registro->area}}</td>
                                        <td>{{$registro->solicita}}</td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
