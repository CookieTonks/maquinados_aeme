                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-2xl	 font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{route('home_administracion_compras')}}">ADMINISTRACION COMPRAS </a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-2xl	 font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{route('home_recepcion_material')}}"> ALMACEN </a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-2xl	 font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{route('home_requisiciones_compras_pendientes')}}">COMPRAS</a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-2xl	 font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{route('home_embarques')}}">EMBARQUES</a>
                                            </div>
                                        </div>
                                        <div class="col-auto">
