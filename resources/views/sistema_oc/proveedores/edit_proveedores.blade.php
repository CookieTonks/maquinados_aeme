                ...
                <!-- Begin Page Content -->
                 <div class="card-body">
                   ...
                   @if (session('mensaje'))
                    ...
                    <form action="{{route('update_proveedores',$mostrar)}}" method="post">
                        @method('PUT')
                        @csrf
                      <div class="form-row">
                        <div class="col-md-6 mb-3">
                            <label>Razon social</label>
                          <input type="text" class="form-control" name="Rsocial" value="{{$mostrar->Rsocial}}" name="Rsocial" >
                        </div>

                        <div class="col-md-6 mb-3">
                          <label>RFC </label>
                          <input type="text" class="form-control" value="{{$mostrar->RFC}}" name="RFC" >
                        </div>
                      </div>
                      <div class="form-row">
                      <div class="col-md-4 mb-3">
                          <label>Direccion</label>
                        <input type="text" class="form-control" value="{{$mostrar->Direccion}}" name="Direccion" >
                      </div>
                      <div class="col-md-4 mb-3">
                      ...
                      <div class="col-md-4 mb-3">
                        <label>Correo</label>
                        <input type="text" class="form-control" value="{{$mostrar->Correo}}" name="Correo"  >
                      </div>
                      </div>
                      <div class="form-row">
                      ...
                      <input type="text" class="form-control" name="Vendedor" value="{{$mostrar->Vendedor}}" name="Vendedor" >
                      </div>
                      </div>
                      </div>
                      <div class="form-row">
                      <div class="col-md-6 mb-2">
                      <a href="{{route('home_proveedores')}}" class="btn btn-primary btn-block">Regresar</a>
                      </div>
                      <div class="col-md-6 mb-2">
                      <button type="submit" class="btn btn-success btn-block" style="float: inline-end;">Guardar</button>
                      </div>
                      </div>
                      </form>
              </div>
