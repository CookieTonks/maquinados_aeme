...
<body>
  ...
  <table class="table table-sm table-striped" style="text-align: center; font-size:x-small;">
    <thead style="background-color:rgb(18, 77, 143); color:white;">
      <tr>
    ...
    <tbody style="font-size:xx-small;">
      ...
      <tr>
        ...
        <td style="width:50px;">{{$item->material}}</td>
        <td style="width:50px;">{{$item->user}}</td>
  ...
  <table class="table table-borderless table-sm" style="text-align: center;font-size:x-small;">
    <thead>
      <tr>
        <th style="width:450px; text-align:center;">Observaciones</th>
        <th></th>
      ...
      <tr>
        <td>
          <p style="font-size:x-small; text-align: center;">No se recibirá material si no cuenta con la siguiente papeleria impresa:
            <u><b>ORDEN DE COMPRA, FACTURA Y CERTIFICADO DE MATERIAL.</b></u>
          </p>
          <p style="font-size:x-small;"> Comprador: <u> {{Auth::user()->name}} </u> </p>
          <p style="font-size:medium; text-align: right;"> <strong> FC0 02, rev 05 </strong></p>
        </td>
      </tr>
    </tbody>
  </table>
