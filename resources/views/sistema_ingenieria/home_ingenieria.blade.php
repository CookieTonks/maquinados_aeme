...
<body id="page-top">
                 ...
                 <div class="card-body">
                   @if (session('mensaje'))
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                          <h1 class="h3 mb-0 text-gray-800">SISTEMA INGENIERIA</h1>
                          <a href="{{route('exportar_ingenieria')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="modal fade" id="modal_diseno_responsable" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
                      ...
                      <div class="form-row">
                        <div class="col-md-12 mb-3">
                          ...
                          <select name="data_responsable" id="proveedor_id" class="form-control">
                            ...
                            <option value="STEVE MORA" class="form-control" name="cliente"> STEVE MORA </option>
                          </select>
                        </div>
                      </div>
    ...
    <div class="modal fade" id="modal_diseno_proceso" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
    ...
    <div class="modal fade" id="modal_diseno_completado" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
