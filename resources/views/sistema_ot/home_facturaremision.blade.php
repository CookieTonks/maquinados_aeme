    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="card-body">
          ...
          @endif
          <div class="card-body">
            <form action="{{route('pdf_remision', $mostrar)}}" method="post" enctype="multipart/form-data">
              @method('GET')
              @csrf
              <div class="form-row">
                <div class="col-md-12 mb-3">
                  <label># Orden</label>
                  <input type="text" name="orden" value="{{$mostrar->orden_trabajo}}" class="form-control" readonly>
                </div>
              </div>
              <div class="form-row">
                <div class="col-md-6 mb-3">
                  <label><b>CANTIDAD DE PIEZAS A ENTREGAR:</b></label>
                  <input type="text" name="factura_remision" class="form-control" required>
                </div>
                <div class="col-md-6 mb-3">
          ...
          <div class="form-row">
            ...
            <div class="col-md-6 mb-2">
              <button type="submit" class="btn btn-success btn-block" style="float: inline-end;">GENERAR REMISION</button>
            </div>
          </div>
          </form>
        </div>
